...
function [consoleout, A1, A2, A3, A4, A5, A6, A7, A8, A9] = solution()
 [consoleout, A1, A2, A3, A4, A5, A6, A7, A8, A9] = evalc('student_solution(0)'); 
end

function [A1, A2, A3, A4, A5, A6, A7, A8, A9] = student_solution(dummy_argument)
    % Problem 1
