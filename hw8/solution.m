% Homework 8 MATLAB template file
% Your main file should be named "solution.m" and it should be saved as UTF-8 file.

function [consoleout, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10] = solution()
 [consoleout, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10] = evalc('student_solution(0)'); 
end

function [A1, A2, A3, A4, A5, A6, A7, A8, A9, A10] = student_solution(dummy_argument)
